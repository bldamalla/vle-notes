...
md"This represents the range we'll be working on---the physically realizable mole
fractions of solute within a solvent. As a matter of convention, we'll be working
with an ordered liquid pair ``\{1,2\}``."

# ╔═╡ c8200eda-2d86-44dc-8cc1-106fec074c12
xs = 0.0:0.01:1.0

# ╔═╡ 66c5d8ed-6f9a-432f-983f-f6b911a25350
md"According to the Margules activity model, the activity coefficients are
...
function γ1(x1)
	return exp((A12 + 2(A21 - A12) * x1) * (1-x1)^2)
end

# ╔═╡ f7ecc91a-9f2a-4f35-ad5d-05c66c793cca
## we'll define the other activity coefficient similarly

function γ2(x1)
	return exp((A21 + 2(A12 - A21) * (1-x1)) * x1^2)
end

# ╔═╡ 597996d7-0e92-464a-be25-5ec929ef2e95
md"We'll see how plots of these functions look like!"

# ╔═╡ c97662e7-37fa-4bf8-8f7c-c0c7d4d67cfb
begin
	plot(xs, γ1.(xs); label="Liquid 1")
	plot!(xs, γ2.(xs); label="Liquid 2")
end
...
md"Feel free to change the values of the vapor pressures and Margules coefficients.
